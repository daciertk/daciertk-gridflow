...
and statistical functions mean, median, max and min over a set of cells. A writeup and demonstration of GridFlow is available [here on my personal website] (daciertk.github.io/projects/gridflow.html)
